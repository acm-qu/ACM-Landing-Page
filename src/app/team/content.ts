...
export const HEADS: ITeamMember[] = [
  { name: "Sifna Nasar", role: "Lead of the Public Relations Team - ", image: '/team/lady.jpg', borderColor: 'linear-gradient(to right, #e803fc, #e7b3f2)', quote: "i'm the head of pr or something idk" },
  { name: "Amna Bushra", role: "Lead of the Creative Team - ", image: '/team/lady.jpg', borderColor: 'linear-gradient(to top right, #84e0fa, #c0e1fc)', quote: "i'm the head of creative or something idk" },
  { name: "Moaz Jemmieh", role: "Lead of the Event Planning Team - ", image: '/team/moaz.jpg', borderColor: 'linear-gradient(to top right, #67fa4d, #c2f29b)', quote: "i'm the head of event planning or something idk" },
  { name: "Sham Alkhais", role: "Lead of the Event Planning Team - ", image: '/team/lady.jpg', borderColor: 'linear-gradient(to top right, #67fa4d, #c2f29b)', quote: "i'm the head of event planning or something idk" },
  { name: "Mohamed Al-Ansary", role: "Lead of the Technical Team - ", image: '/team/mohamed.jpg', borderColor: 'linear-gradient(to top right, #fa4d4dff, #f29b9bff)', quote: "i'm the head of technical or something idk" },
]

export const PAST_PRESIDENTS: ITeamMember[] = [
...
export const PAST_HEADS: ITeamMember[] = [
